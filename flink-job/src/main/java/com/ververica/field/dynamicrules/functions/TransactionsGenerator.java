...
import com.ververica.field.dynamicrules.DefaultTransaction;
import com.ververica.field.dynamicrules.Transaction;
import com.ververica.field.dynamicrules.DefaultTransaction.PaymentType;
import com.ververica.field.sources.BaseGenerator;
import java.math.BigDecimal;
import java.util.SplittableRandom;
import java.util.concurrent.ThreadLocalRandom;

public class TransactionsGenerator extends BaseGenerator<DefaultTransaction> {
  ...
  @Override
  public DefaultTransaction randomEvent(SplittableRandom rnd, long id) {
