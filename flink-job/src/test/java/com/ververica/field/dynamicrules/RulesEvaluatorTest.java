...
public class RulesEvaluatorTest {
  ...
  public void shouldProduceKeyedOutput() throws Exception {
    ...
    Transaction event1 = DefaultTransaction.fromString("1,2013-01-01 00:00:00,1001,1002,CSH,21.5,1");
  ...
  public void shouldOutputSimplestAlert() throws Exception {
    ...
    Transaction event1 = DefaultTransaction.fromString("1,2013-01-01 00:00:00,1001,1002,CSH,22,1");
    Transaction event2 = DefaultTransaction.fromString("2,2013-01-01 00:00:01,1001,1002,CRD,19,1");
    Transaction event3 = DefaultTransaction.fromString("3,2013-01-01 00:00:02,1001,1002,CRD,2,1");
  ...
  public void shouldHandleSameTimestampEventsCorrectly() throws Exception {
    ...
    Transaction event1 = DefaultTransaction.fromString("1,2013-01-01 00:00:00,1001,1002,CSH,19,1");

    Transaction event2 = DefaultTransaction.fromString("2,2013-01-01 00:00:00,1002,1003,CSH,2,1");
  ...
  public void shouldCleanupStateBasedOnWatermarks() throws Exception {
    ...
    Transaction event1 = DefaultTransaction.fromString("1,2013-01-01 00:01:00,1001,1002,CSH,3,1");

    Transaction event2 = DefaultTransaction.fromString("2,2013-01-01 00:02:00,1003,1004,CSH,3,1");

    Transaction event3 = DefaultTransaction.fromString("3,2013-01-01 00:03:00,1005,1006,CSH,5,1");

    Transaction event4 = DefaultTransaction.fromString("4,2013-01-01 00:06:00,1007,1008,CSH,3,1");
