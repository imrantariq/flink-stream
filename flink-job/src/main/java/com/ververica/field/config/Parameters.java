...
public class Parameters {
  ...
  // Socket
  public static final Param<Integer> SOCKET_PORT = Param.integer("pubsub-rules-export", 9991);
  public static final Param<Integer> TRANSACTION_SOCKET_PORT = Param.integer("pubsub-transaction-export", 9992);

  // General:
  //    source/sink types: kafka / pubsub / socket
  public static final Param<String> RULES_SOURCE = Param.string("rules-source", "SOCKET");
  public static final Param<String> TRANSACTIONS_SOURCE = Param.string("data-source", "SOCKET");//Param.string("data-source", "GENERATOR");
  ...
  public static final Param<Boolean> LOCAL_EXECUTION = Param.bool("local", true);
